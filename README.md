...
Python wrapper `PiQTree2`
-----------------------

For details on the Python wrapper PiQTree2 please refer to the [PiQTree2 documentation](https://github.com/cogent3/piqtree2/blob/master/piqtree2/README.md)
